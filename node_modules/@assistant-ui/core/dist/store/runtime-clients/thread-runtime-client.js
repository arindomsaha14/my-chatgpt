...
const useThreadClient = (t0) => {
	...
	let t12;
	if ($[37] !== runtime.append || $[38] !== runtime.cancelRun || $[39] !== runtime.connectVoice || $[40] !== runtime.deleteMessage || $[41] !== runtime.disconnectVoice || $[42] !== runtime.export || $[43] !== runtime.getModelContext || $[44] !== runtime.getVoiceVolume || $[45] !== runtime.import || $[46] !== runtime.importExternalState || $[47] !== runtime.muteVoice || $[48] !== runtime.reset || $[49] !== runtime.resumeRun || $[50] !== runtime.startRun || $[51] !== runtime.stopSpeaking || $[52] !== runtime.subscribeVoiceVolume || $[53] !== runtime.unmuteVoice || $[54] !== t10 || $[55] !== t11 || $[56] !== t8 || $[57] !== t9) {
		t12 = {
			getState: t8,
			composer: t9,
		...
		$[45] = runtime.import;
		$[46] = runtime.importExternalState;
		$[47] = runtime.muteVoice;
		$[48] = runtime.reset;
		$[49] = runtime.resumeRun;
		$[50] = runtime.startRun;
		$[51] = runtime.stopSpeaking;
		$[52] = runtime.subscribeVoiceVolume;
		$[53] = runtime.unmuteVoice;
		$[54] = t10;
		$[55] = t11;
		$[56] = t8;
		$[57] = t9;
