...
const useSuggestionTrigger = (t0) => {
	...
	let t2;
	if ($[0] !== resolvedSend) {
		t2 = (s) => s.thread.isDisabled || resolvedSend && s.thread.isRunning && !s.thread.capabilities.queue;
		$[0] = resolvedSend;
		$[1] = t2;
	} else t2 = $[1];
