...
var AssistantCloudThreads = class {
	...
	async list(query) {
		const response = readCloudRecord(await this.cloud.makeRequest("/threads", { query }), "thread list response");
